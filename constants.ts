...
export const PRODUCTS: Product[] = [
  ...
  },
  {
    ...
    price: 25.00,
    category: 'Sobremesas',
    imageUrl: 'https://images.unsplash.com/photo-1528975604071-b4dc52a2d18c?q=80&w=800&auto=format&fit=crop'
  },
  {
    id: 'mousse-maracuja',
  ...
  {
    id: 'tempero-vovo',
    name: 'Tempero Completo da Roça',
    description: 'Mix de ervas frescas e alho socado no pilão. Sem conservantes, puro sabor.',
    price: 10.00,
    category: 'Temperos',
    imageUrl: 'https://images.unsplash.com/photo-1532336411638-af7294203463?q=80&w=800&auto=format&fit=crop'
  },
  {
    id: 'cha-quintal',
    ...
    price: 8.50,
    category: 'Chás',
    imageUrl: 'https://images.unsplash.com/photo-1564890369478-c89ca6d9cde9?q=80&w=800&auto=format&fit=crop'
  }
];
